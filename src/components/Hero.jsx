  ...
  return (
    <>
        ...
        <section className='relative z-20 '>
          ...
          <div className='flex  md:flex-row sm sm:flex-col shadow-lg bg-white lg:py-8 md:py-5 rounded-[0.5rem] lg:left-[6.5rem] md:left-[6.5rem] sm:left-[26%] lg:-top-[5rem] md:-top-[3.5rem] sm:-top-[8rem] absolute'>
            ...
            <div className=' sm:px-16  sm:pb-5 flex flex-col  md:items-start sm:items-center'>
              ...
              <h1 className='font-medium capitalize  lg:text-lg text-base  sm:w-[8rem] sm:text-center  '>{address.isp}</h1>
            </div>
